Prerequisites: docker-engine 1.13, bash, awscli (if you're spinning up aws docker-machines). Includes portainer for example swarm management and a run_machine script which runs a command on all docker-machines created from a host. 
